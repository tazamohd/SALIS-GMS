...
import type { NextGenRepository } from '../../modules/nextgen/repositories/nextgen.repository';
...
import type { LoyaltyRepository } from '../../modules/loyalty/repositories/loyalty.repository';
import type { LoyaltyService } from '../../modules/loyalty/services/loyalty.service';
...
export const NEXTGEN_REPOSITORY = token<NextGenRepository>('NextGenRepository');
...
export const LOYALTY_REPOSITORY = token<LoyaltyRepository>('LoyaltyRepository');
export const LOYALTY_SERVICE = token<LoyaltyService>('LoyaltyService');
