...
import type { TaxRepository } from '../../modules/tax/repositories/tax.repository';
import type { TaxService } from '../../modules/tax/services/tax.service';
...
export const TAX_REPOSITORY = token<TaxRepository>('TaxRepository');
