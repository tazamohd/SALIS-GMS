...
import {
  ...
  TELEMATICS_SERVICE,
  SUBSCRIPTION_LICENSE_REPOSITORY,
  SUBSCRIPTION_LICENSE_SERVICE,
...
import { SubscriptionLicenseRepository } from '../../modules/subscription-licenses/repositories/subscription-license.repository';
import { SubscriptionLicenseService } from '../../modules/subscription-licenses/services/subscription-license.service';
...
export function getAppContainer(): Container {
  ...
  c.register(SUBSCRIPTION_LICENSE_REPOSITORY, () => new SubscriptionLicenseRepository());
  c.register(SUBSCRIPTION_LICENSE_SERVICE, (ctx) => new SubscriptionLicenseService(ctx.resolve(SUBSCRIPTION_LICENSE_REPOSITORY)));
