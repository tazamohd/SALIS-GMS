...
import { TaxRepository } from '../../modules/tax/repositories/tax.repository';
import { TaxService } from '../../modules/tax/services/tax.service';
...
export function getAppContainer(): Container {
  ...
  c.register(TAX_REPOSITORY, () => new TaxRepository());
  c.register(TAX_SERVICE, (ctx) => new TaxService(ctx.resolve(TAX_REPOSITORY)));
