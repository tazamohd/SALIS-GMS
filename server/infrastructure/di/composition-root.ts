...
import { WarrantyRepository } from '../../modules/warranty/repositories/warranty.repository';
import { WarrantyService } from '../../modules/warranty/services/warranty.service';
...
export function getAppContainer(): Container {
  ...
  c.register(WARRANTY_REPOSITORY, () => new WarrantyRepository());
  c.register(WARRANTY_SERVICE, (ctx) => new WarrantyService(ctx.resolve(WARRANTY_REPOSITORY)));
