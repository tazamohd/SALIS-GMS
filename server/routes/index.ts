...
import warrantyModuleRoutes from "../modules/warranty";
...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  // Warranty (warranties + status-window lookups and warranty-claims) — extracted from the monolith
  app.use("/api", warrantyModuleRoutes);
