...
import subscriptionLicenseRoutes from "../modules/subscription-licenses";
...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  // Notifications (in-app CRUD, test, email/SMS triggers, /my/notifications) — extracted from the monolith
  ...
  // Dynamic pricing (market-data, vehicle-factors, suggestions, calculate, catalogues) — extracted from the monolith
  ...
  // Subscription licenses (license CRUD + per-license audit logs) — extracted from the monolith
  app.use("/api", subscriptionLicenseRoutes);
  ...
  app.use("/api", fleetTrackingRoutes);
