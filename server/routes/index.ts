...
import { loyaltyTiersRoutes } from "./loyalty-tiers.routes";
...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  // Loyalty tiers (tenant-scoped + RBAC) — mounted ahead of the monolith
  app.use("/api", loyaltyTiersRoutes);
  console.log("✅ Loyalty Tiers Routes Loaded");

  // AR instructions/sessions/devices (tenant-scoped) — mounted ahead of the monolith
  app.use("/api", arRoutes);
  console.log("✅ AR Routes Loaded");

  // Inventory forecasts (tenant-scoped) — mounted ahead of the monolith
  app.use("/api", inventoryForecastsRoutes);
  console.log("✅ Inventory Forecasts Routes Loaded");
  ...
  // Discounts & promotions (tenant-scoped + RBAC) — mounted ahead of the monolith
  app.use("/api", discountsRoutes);
  console.log("✅ Discounts Routes Loaded");

  // Tax configurations (tenant-scoped + RBAC) — mounted ahead of the monolith
  app.use("/api", taxConfigurationsRoutes);
  console.log("✅ Tax Configurations Routes Loaded");

  // Saved filter presets (garage + user scoped) — mounted ahead of the monolith
  app.use("/api", filterPresetsRoutes);
  console.log("✅ Filter Presets Routes Loaded");
  ...
  // Refunds (tenant-scoped + RBAC) — mounted ahead of the monolith
