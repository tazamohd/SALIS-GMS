...
router.get('/catalogs/vehicle-makes', isAuthenticated, async (_req, res) => {
  try {
...
router.get('/catalogs/nationalities', isAuthenticated, async (_req, res) => {
  try {
...
router.get('/catalogs/years', isAuthenticated, async (_req, res) => {
  try {
...
router.get('/catalogs/colors', isAuthenticated, async (_req, res) => {
  try {
...
router.get('/catalogs/engine-types', isAuthenticated, async (_req, res) => {
  try {
...
router.get('/catalogs/transmission-types', isAuthenticated, async (_req, res) => {
  try {
