...
router.get('/audit/log', isAuthenticated, asyncHandler(async (req, res) => {
...
router.get('/audit/stats', isAuthenticated, asyncHandler(async (req, res) => {
  const garageId = (req as any).user.garageId;
  res.json(await getAuditStats(garageId));
}));

router.post('/audit/seed', isAuthenticated, asyncHandler(async (req, res) => {
  const garageId = (req as any).user.garageId;
