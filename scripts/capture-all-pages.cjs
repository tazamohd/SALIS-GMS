...
// ALL pages in order - organized by section
const routes = [
  // === DASHBOARD & HOME ===
  ...
  { path: '/edge-computing', name: 'Edge-Computing' },
...
async function captureScreenshots() {
  ...
  console.log('SALIS AUTO - Full HD Screenshot Capture (1920x1080)');
  console.log('='.repeat(60));
