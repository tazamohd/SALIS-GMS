...
export const navigationConfig: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Chat", href: "/chat", icon: Bell },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { title: "NextGen Tech", href: "/nextgen-technologies", icon: TrendingUp },
  ...
  },
  {
    ...
    items: [
      ...
      { title: "AI Chatbot", href: "/ai-chatbot", icon: Bell },
      { title: "AI Service Advisor", href: "/ai-service-advisor", icon: Brain },
      { title: "Voice Commands", href: "/voice-commands", icon: Radio },
    ],
  },
  {
