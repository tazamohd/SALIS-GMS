...
export const navigationConfig: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Supplier Portal", href: "/supplier-portal", icon: Store },
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Multi-Currency", href: "/currency-settings", icon: Globe },
  ...
  },
  {
    ...
    items: [
      ...
      { title: "SMS Campaigns", href: "/sms-campaigns", icon: Mail },
  ...
  },
  {
    ...
    items: [
      ...
      { title: "API Documentation", href: "/api-docs", icon: BookOpen },
    ],
  },
];
