...
export default function PaymentTracking() {
  ...
  const stats = [
    { label: "Pending Approval", value: totalPending, count: payments.filter(p => p.status === "pending" || p.status === "approved").length, icon: Clock, color: "text-gray-500", bgColor: "bg-gray-100 dark:bg-gray-800" },
        ...
        <CardHeader>
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              ...
              <CardDescription>Track and manage all supplier payments</CardDescription>
            </div>
                ...
                <table className="w-full">
                  <thead>
                    <tr className="border-b">
                      ...
                      <th className="text-left py-3 px-4 font-medium text-gray-600 dark:text-gray-400">Invoice</th>
                    ...
                    {filteredPayments.length === 0 ? (
                      ...
                      filteredPayments.map((payment) => (
                        ...
                        >
                          ...
                          <td className="py-3 px-4">
                            <p className="font-medium text-gray-900 dark:text-white">{payment.supplierName}</p>
                            ...
                            <Dialog>
                              ...
                              <DialogContent className="max-w-lg">
                                <DialogHeader>
                                  ...
                                  <DialogDescription>{payment.orderNumber}</DialogDescription>
                                </DialogHeader>
                                <div className="space-y-4">
                                  <div className="flex justify-between items-center p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
                                    <div>
                                      <p className="text-sm text-gray-500">Amount</p>
                                      <p className="text-2xl font-bold">{payment.amount.toLocaleString()} {payment.currency}</p>
                                    </div>
                                    {getStatusBadge(payment.status)}
                                  </div>
                                  ...
                                  <div className="grid grid-cols-2 gap-4">
                                    ...
                                    <div>
                                      ...
                                      <p className="font-medium">{payment.supplierBank}</p>
                                    </div>
                                    <div className="col-span-2">
                                      <p className="text-sm text-gray-500">IBAN</p>
                                      <p className="font-mono text-sm">{payment.supplierIban}</p>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                      ...
                                      <p className="font-medium">{new Date(payment.invoiceDate).toLocaleDateString()}</p>
                                    </div>
                                    <div>
                                  ...
                                  {payment.notes && (
                                    <div>
                                      ...
                                      <p className="text-sm p-2 bg-gray-50 dark:bg-gray-800 rounded">{payment.notes}</p>
                                    </div>
                                  )}
                                  ...
                                  {payment.guidanceNotes && (
                                    <div className="p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                                      ...
                                      <p className="text-sm text-blue-600 dark:text-blue-300">{payment.guidanceNotes}</p>
                                    </div>
                                  )}
