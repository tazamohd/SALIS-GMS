  ...
  return (
    <div className="p-6 space-y-6" data-testid="page-technician-management">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold" data-testid="text-title">Technician Management</h1>
                  ...
                  {profile?.speciality && (
                    <div className="flex items-start gap-2" data-testid={`text-speciality-${technician.id}`}>
                      ...
                      <div className="text-sm">
                        ...
                        <div className="text-muted-foreground">{profile.speciality}</div>
                      </div>
                    </div>
                  )}
                  ...
                  {profile?.yearsOfExperience !== undefined && (
                    <div className="flex items-start gap-2" data-testid={`text-experience-${technician.id}`}>
                      ...
                      <div className="text-sm">
                        ...
                        <div className="text-muted-foreground">{profile.yearsOfExperience} years</div>
                      </div>
                    </div>
                  )}
                  ...
                  {profile?.hourlyRate && (
                    <div className="flex items-start gap-2" data-testid={`text-rate-${technician.id}`}>
                      ...
                      <div className="text-sm">
                        ...
                        <div className="text-muted-foreground">${profile.hourlyRate}/hr</div>
                      </div>
                    </div>
                  )}
                  ...
                  {profile?.qualifications && (
                    <div className="flex items-start gap-2" data-testid={`text-qualifications-${technician.id}`}>
                      ...
                      <div className="text-sm">
                        ...
                        <div className="text-muted-foreground text-xs line-clamp-2">{profile.qualifications}</div>
                      </div>
                    </div>
                  )}
                  ...
                  {profile?.certifications && (
                    <div className="flex items-start gap-2" data-testid={`text-certifications-${technician.id}`}>
                      ...
                      <div className="text-sm">
                        ...
                        <div className="text-muted-foreground text-xs line-clamp-2">{profile.certifications}</div>
                      </div>
                    </div>
                  )}
                </CardContent>
