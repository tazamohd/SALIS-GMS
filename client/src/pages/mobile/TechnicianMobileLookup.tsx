...
export default function TechnicianMobileLookup() {
  ...
  return (
    <div className="p-4 space-y-4">
      {/* Header */}
      <div>
        <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Parts Lookup</h2>
        <p className="text-sm text-gray-500 dark:text-gray-400">Search inventory and check availability</p>
      </div>
      ...
      <Card className="bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-800">
        <CardContent className="p-4">
          ...
          <Button 
            ...
            className="w-full"
            onClick={() => {
              // Would open camera/barcode scanner
      ...
      {searchQuery.length > 2 && (
        <div className="space-y-2">
          {isLoading ? (
                ...
                <CardContent className="p-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      <h3 className="font-semibold text-gray-900 dark:text-white mb-1">{part.partName}</h3>
            ...
            <Card className="bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-800">
              <CardContent className="p-8 text-center">
                <Package className="h-16 w-16 mx-auto mb-4 text-gray-300 dark:text-gray-700" />
                <h3 className="text-lg font-semibold mb-2 text-gray-900 dark:text-white">No Parts Found</h3>
      ...
      {searchQuery.length <= 2 && (
        <Card className="bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-800">
          <CardContent className="p-8 text-center">
            ...
            <h3 className="text-lg font-semibold mb-2 text-gray-900 dark:text-white">Search Parts</h3>
            <p className="text-sm text-gray-500 dark:text-gray-400">
