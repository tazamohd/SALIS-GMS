    ...
    <div className="flex-1 p-6 bg-gray-50 dark:bg-salis-black min-h-screen">
      <div className="mb-6">
        ...
        <p className="text-gray-600 dark:text-gray-400">
          Multi-channel reminders (SMS, Email, WhatsApp) with no-show tracking and analytics
        </p>
      </div>
      ...
      <Tabs value={selectedTab} onValueChange={setSelectedTab} className="space-y-6">
        <TabsList className="bg-white dark:bg-salis-black">
          <TabsTrigger value="overview">Reminder Logs</TabsTrigger>
          <TabsTrigger value="noshows">No-Show Tracking</TabsTrigger>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  id="email-template"
                  rows={6}
                  defaultValue="Dear {customerName},&#10;&#10;This is a friendly reminder about your upcoming appointment at {garageName}.&#10;&#10;Appointment Details:&#10;- Date & Time: {appointmentTime}&#10;- Vehicle: {vehicleMake} {vehicleModel}&#10;- Service: {serviceType}&#10;&#10;If you need to reschedule, please contact us at {garagePhone}.&#10;&#10;Thank you!"
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  rows={4}
                  defaultValue="Hi {customerName}, thank you for choosing {garageName}! We hope you're satisfied with the service on your {vehicleMake} {vehicleModel}. We'd love your feedback! Reply with a rating 1-5 stars."
                  data-testid="textarea-followup-template"
                />
              </div>

              <Button className="bg-purple-600 hover:bg-purple-700" data-testid="button-save-templates">
                Save Templates
              </Button>
            </CardContent>
          </Card>
