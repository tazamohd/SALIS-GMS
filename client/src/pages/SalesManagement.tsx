    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <Card className="bg-white dark:bg-[#151A23] border-[#E2E8F0] dark:border-[#232A36]" data-testid="card-service-revenue">
          ...
          <CardContent>
            ...
            <p className="text-xs text-[#64748B] mt-1">{t('salesManagement.serviceRevenueAr', 'Service Revenue Ar')}</p>
          </CardContent>
        </Card>
        ...
        <Card className="bg-white dark:bg-[#151A23] border-[#E2E8F0] dark:border-[#232A36]" data-testid="card-parts-revenue">
          ...
          <CardContent>
            ...
            <p className="text-xs text-[#64748B] mt-1">{t('salesManagement.partsRevenueAr', 'Parts Revenue Ar')}</p>
          </CardContent>
        </Card>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card className="bg-white dark:bg-[#151A23] border-[#E2E8F0] dark:border-[#232A36]">
          <CardHeader>
            ...
            <CardDescription className="text-[#64748B]">{t('salesManagement.monthlySalesTrendDesc', 'Last 6 months')}</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card className="bg-white dark:bg-[#151A23] border-[#E2E8F0] dark:border-[#232A36]">
          <CardHeader>
            ...
            <CardDescription className="text-[#64748B]">{t('salesManagement.topSellingProductsAr', 'Top Selling Products Ar')}</CardDescription>
          </CardHeader>
          <CardContent>
            <Table>
              <TableHeader>
      ...
      <Card className="bg-white dark:bg-[#151A23] border-[#E2E8F0] dark:border-[#232A36]">
        <CardHeader>
          ...
          <CardDescription className="text-[#64748B]">{t('salesManagement.relatedFinancialModulesDesc', 'Quick access to related accounting')}</CardDescription>
        </CardHeader>
        <CardContent>
            ...
            <Link href="/expenses-management">
              <Card className="cursor-pointer hover:border-[#0A5ED7] transition-colors h-full bg-white dark:bg-[#151A23] border-[#E2E8F0] dark:border-[#232A36]" data-testid="link-expenses-management">
                <CardHeader className="pb-2">
                  ...
                  <CardDescription className="text-[#64748B]">{t('salesManagement.expensesManagementAr', 'Expenses Management Ar')}</CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <Link href="/invoices">
              <Card className="cursor-pointer hover:border-[#0A5ED7] transition-colors h-full bg-white dark:bg-[#151A23] border-[#E2E8F0] dark:border-[#232A36]" data-testid="link-invoices">
                <CardHeader className="pb-2">
                  ...
                  <CardDescription className="text-[#64748B]">{t('salesManagement.invoicesAr', 'Invoices Ar')}</CardDescription>
                </CardHeader>
                <CardContent>
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription className="text-[#64748B]">{t('salesManagement.salesTransactionsDesc', 'All sales records')}</CardDescription>
            </div>
            <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
              ...
              <DialogContent className="max-w-2xl bg-white dark:bg-[#151A23] border-[#E2E8F0] dark:border-[#232A36]" data-testid="modal-add-sale">
                <DialogHeader>
                  ...
                  <DialogDescription className="text-[#64748B]">{t('salesManagement.recordNewSaleAr', 'Record New Sale Ar')}</DialogDescription>
                </DialogHeader>
                <Form {...form}>
