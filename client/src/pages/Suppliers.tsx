  ...
  return (
    <div className="p-8 bg-gray-50 dark:bg-salis-black min-h-screen space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="font-['Poppins',Helvetica] font-bold text-3xl text-gray-900 dark:text-white" data-testid="page-title">Suppliers</h1>
          <p className="text-gray-900 dark:text-white/60">Manage your supplier network</p>
        </div>
