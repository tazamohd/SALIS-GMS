...
export default function FleetTracking() {
  ...
  const stats = [
    ...
    },
    {
      ...
      value: recentEvents,
      icon: AlertTriangle,
      color: recentEvents > 0 ? 'text-orange-500' : 'text-gray-500',
      bgColor: recentEvents > 0 ? 'bg-orange-100 dark:bg-orange-900/30' : 'bg-gray-100 dark:bg-gray-900/30',
    },
  ];
    ...
    <div className="flex-1 p-6 bg-gray-50 dark:bg-salis-black min-h-screen">
      <div className="mb-6">
        ...
        <p className="text-gray-600 dark:text-gray-400 font-['Poppins']">
          Real-time vehicle tracking, geofencing, and route management
        </p>
      </div>
      ...
      <Tabs defaultValue="overview" className="space-y-6">
        <TabsList>
          ...
          <TabsTrigger value="geofences" data-testid="tab-geofences">
        ...
        <DialogContent>
          ...
          <DialogFooter>
            ...
            <Button onClick={handleCreateGeofence} disabled={createGeofenceMutation.isPending}>
              {createGeofenceMutation.isPending && <Loader2 className="h-4 w-4 mr-2 animate-spin" />}
              Create Geofence
            </Button>
          </DialogFooter>
        </DialogContent>
