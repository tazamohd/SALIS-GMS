    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <Card className="bg-white dark:bg-[#151A23] border-[#E2E8F0] dark:border-[#232A36]" data-testid="card-share-capital">
          ...
          <CardContent>
            ...
            <p className="text-xs text-[#64748B] mt-1">{t('equity.shareCapitalAr', 'Share Capital Ar')}</p>
          </CardContent>
        </Card>
        ...
        <Card className="bg-white dark:bg-[#151A23] border-[#E2E8F0] dark:border-[#232A36]" data-testid="card-retained-earnings">
          ...
          <CardContent>
            ...
            <p className="text-xs text-[#64748B] mt-1">{t('equity.retainedEarningsAr', 'Retained Earnings Ar')}</p>
          </CardContent>
        </Card>
        ...
        <Card className="bg-white dark:bg-[#151A23] border-[#E2E8F0] dark:border-[#232A36]" data-testid="card-roe">
          ...
          <CardContent>
            ...
            <p className="text-xs text-[#0A5ED7] mt-1">{t('equity.returnOnEquityAr', 'Return On Equity Ar')}</p>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card className="bg-white dark:bg-[#151A23] border-[#E2E8F0] dark:border-[#232A36]">
          <CardHeader>
            ...
            <CardDescription className="text-[#64748B]">{t('equity.equityCompositionAr', 'Equity Composition Ar')}</CardDescription>
          </CardHeader>
          <CardContent>
      ...
      <Card className="bg-white dark:bg-[#151A23] border-[#E2E8F0] dark:border-[#232A36]">
        <CardHeader>
          ...
          <CardDescription className="text-[#64748B]">{t('equity.keyFinancialRatiosAr', 'Key Financial Ratios Ar')}</CardDescription>
        </CardHeader>
        <CardContent>
            ...
            <Link href="/capital-management">
              <Card className="cursor-pointer hover:border-[#0A5ED7] transition-colors h-full bg-white dark:bg-[#151A23] border-[#E2E8F0] dark:border-[#232A36]" data-testid="link-capital-management">
                <CardHeader className="pb-2">
                  ...
                  <CardDescription className="text-[#64748B]">{t('equity.capitalManagementAr', 'Capital Management Ar')}</CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <Link href="/partners-current-account">
              <Card className="cursor-pointer hover:border-[#0A5ED7] transition-colors h-full bg-white dark:bg-[#151A23] border-[#E2E8F0] dark:border-[#232A36]" data-testid="link-partners-account">
                <CardHeader className="pb-2">
                  ...
                  <CardDescription className="text-[#64748B]">{t('equity.partnersAccountAr', 'Partners Account Ar')}</CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <Link href="/retained-earnings">
              <Card className="cursor-pointer hover:border-[#0A5ED7] transition-colors h-full bg-white dark:bg-[#151A23] border-[#E2E8F0] dark:border-[#232A36]" data-testid="link-retained-earnings">
                <CardHeader className="pb-2">
                  ...
                  <CardDescription className="text-[#64748B]">{t('equity.retainedEarningsLinkAr', 'Retained Earnings Link Ar')}</CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
              ...
              <DialogContent className="max-w-2xl bg-white dark:bg-[#151A23] border-[#E2E8F0] dark:border-[#232A36]" data-testid="modal-add-capital">
                <DialogHeader>
                  ...
                  <DialogDescription className="text-[#64748B]">{t('equity.addCapitalEntryAr', 'Add Capital Entry Ar')}</DialogDescription>
                </DialogHeader>
                <Form {...form}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Card className="bg-white dark:bg-[#151A23] border-[#E2E8F0] dark:border-[#232A36]">
          <CardHeader>
            ...
            <CardDescription className="text-[#64748B]">{t('equity.ownershipStructureAr', 'Ownership Structure Ar')}</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
        ...
        <Card className="bg-white dark:bg-[#151A23] border-[#E2E8F0] dark:border-[#232A36]">
          <CardHeader>
            ...
            <CardDescription className="text-[#64748B]">{t('equity.dividendHistoryAr', 'Dividend History Ar')}</CardDescription>
          </CardHeader>
          <CardContent>
            <Table>
              <TableHeader>
