...
export default function CustomReportBuilder() {
        ...
        {selectedFields.length === 0 ? (
          <div className="text-center py-16">
            ...
            <p className="text-sm text-gray-400 dark:text-gray-500">
              Select fields from the Configuration tab to build your report
            </p>
          </div>
        ) : (
  ...
  return (
    <TabsPageLayout
      ...
      description="Create custom reports with drag-and-drop fields, choose chart types, and export to PDF/Excel"
      icon={BarChart3}
      tabs={[
        {
          id: "configuration",
