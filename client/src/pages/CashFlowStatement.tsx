          ...
          <Table>
            ...
            <TableBody>
              ...
              {operatingActivities.map((item, index) => (
                <TableRow 
                  key={index} 
                  className={item.isHeader ? "bg-muted/30" : ""}
                  data-testid={`row-operating-${index}`}
                >
                  <TableCell className={`${item.isHeader ? "font-semibold pl-6" : "pl-10"}`}>
                    {item.description}
                  </TableCell>
              ...
              {investingActivities.map((item, index) => (
                <TableRow key={index} data-testid={`row-investing-${index}`}>
              ...
              {financingActivities.map((item, index) => (
                <TableRow key={index} data-testid={`row-financing-${index}`}>
                  <TableCell className="pl-10">{item.description}</TableCell>
                  <TableCell className="text-right">
                    {getAmountDisplay(item.amount)}
                  </TableCell>
  ...
  const analysisTab = (
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <Card data-testid="card-operating-cash">
        ...
        <Card data-testid="card-investing-cash">
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-medium text-muted-foreground flex items-center gap-2">
        ...
        <Card data-testid="card-financing-cash">
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-medium text-muted-foreground flex items-center gap-2">
        ...
        <Card data-testid="card-ending-cash">
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-medium text-muted-foreground flex items-center gap-2">
          ...
          <CardContent>
            ...
            <div className="flex items-center gap-1 text-sm">
              ...
              <span className={netCashChange >= 0 ? "text-green-600" : "text-red-600"}>
