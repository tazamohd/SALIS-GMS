    ...
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="w-full max-w-md p-4">
        <Card className="bg-white/90 dark:bg-[#151A23]/95 border border-[#E2E8F0] dark:border-[#232A36] shadow-2xl">
          <CardHeader>
            <CardTitle className="text-2xl font-bold text-[#0B1F3B] dark:text-white">Create your account</CardTitle>
          ...
          <CardContent>
            <form onSubmit={(e) => { e.preventDefault(); register.mutate(); }} className="space-y-4">
              <div className="space-y-2">
                <Label className="text-[#0B1F3B] dark:text-[#E6EAF0]">Full name</Label>
              ...
              <div className="space-y-2">
                <Label className="text-[#0B1F3B] dark:text-[#E6EAF0]">Email *</Label>
                <div className="relative">
              ...
              <div className="space-y-2">
                <Label className="text-[#0B1F3B] dark:text-[#E6EAF0]">Phone</Label>
                <div className="relative">
              ...
              <div className="space-y-2">
                <Label className="text-[#0B1F3B] dark:text-[#E6EAF0]">Password *</Label>
                <div className="relative">
                  <Lock className="absolute left-3 top-1/2 -translate-y-1/2 h-5 w-5 text-[#94A3B8]" />
                  <Input type="password" className={inputCls} value={form.password} onChange={(e) => set("password", e.target.value)} data-testid="input-password" placeholder="min 8 characters" />
                </div>
              </div>
              ...
              <p className="text-center text-sm text-[#64748B] dark:text-[#9BA4B0] pt-2">
                ...
                {" · "}
                <Link href="/marketplace" className="text-[#0A5ED7] dark:text-[#0BB3FF] hover:underline">Browse providers</Link>
              </p>
            </form>
          </CardContent>
        </Card>
