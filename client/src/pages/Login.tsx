    ...
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-[#080B12] font-sans">
      ...
      <div className="fixed left-0 top-0 bottom-0 w-[40%] pointer-events-none overflow-hidden flex items-center justify-center">
        <div className="relative w-full h-full">
          ...
          <div className="absolute top-[8%] left-[12%] text-[#0BB3FF]/25 text-[10px] tracking-[0.4em] uppercase font-bold">
            {t("login.aiEngine", "AI Engine")}
          </div>
          <div className="absolute top-[22%] left-[6%] text-[#0A5ED7]/20 text-[10px] tracking-[0.4em] uppercase font-bold">
            {t("login.neuralNetwork", "Neural Network")}
          </div>
          <div className="absolute top-[38%] left-[18%] text-[#F97316]/18 text-[10px] tracking-[0.4em] uppercase font-bold">
            {t("login.automation", "Automation")}
          </div>
          <div className="absolute top-[52%] left-[8%] text-[#0BB3FF]/22 text-[10px] tracking-[0.4em] uppercase font-bold">
            {t("login.predictive", "Predictive")}
          </div>
          <div className="absolute top-[68%] left-[15%] text-[#0A5ED7]/18 text-[10px] tracking-[0.4em] uppercase font-bold">
            {t("login.machineLearning", "Machine Learning")}
          </div>
          <div className="absolute top-[82%] left-[10%] text-[#F97316]/15 text-[10px] tracking-[0.4em] uppercase font-bold">
            {t("login.analytics", "Analytics")}
          </div>
          ...
          >
            ...
            <g opacity="0.2" stroke="#0BB3FF" strokeWidth="1" fill="none">
              ...
              {/* Brain pathways */}
              <path
                d="M250,420 Q280,380 320,380 Q360,380 390,420"
                strokeWidth="1.5"
              />
              <path
                d="M250,420 Q280,460 320,460 Q360,460 390,420"
                strokeWidth="1.5"
              />
            ...
            <g opacity="0.15">
              <path
                d="M-50,800 Q100,780 200,820 T400,800"
                stroke="#0BB3FF"
                strokeWidth="2"
                fill="none"
              />
              <path
                d="M-50,830 Q120,810 220,850 T420,830"
                stroke="#0A5ED7"
                strokeWidth="1.5"
                fill="none"
              />
              <path
                d="M-50,860 Q80,840 180,880 T380,860"
                stroke="#F97316"
                strokeWidth="1"
                fill="none"
              />
      ...
      <div className="fixed right-0 top-0 bottom-0 w-[40%] pointer-events-none overflow-hidden flex items-center justify-center">
        <div className="relative w-full h-full">
          {/* Floating Tech Labels */}
          <div className="absolute top-[10%] right-[12%] text-[#0A5ED7]/25 text-[10px] tracking-[0.4em] uppercase font-bold">
            {t("login.smartDiagnostics", "Smart Diagnostics")}
          </div>
          <div className="absolute top-[24%] right-[8%] text-[#0BB3FF]/22 text-[10px] tracking-[0.4em] uppercase font-bold">
            {t("login.iotIntegration", "IoT Integration")}
          </div>
          <div className="absolute top-[40%] right-[16%] text-[#F97316]/18 text-[10px] tracking-[0.4em] uppercase font-bold">
            {t("login.realTime", "Real Time")}
          </div>
          <div className="absolute top-[55%] right-[10%] text-[#0A5ED7]/20 text-[10px] tracking-[0.4em] uppercase font-bold">
            {t("login.cloudPlatform", "Cloud Platform")}
          </div>
          <div className="absolute top-[70%] right-[18%] text-[#0BB3FF]/18 text-[10px] tracking-[0.4em] uppercase font-bold">
            {t("login.dataInsights", "Data Insights")}
          </div>
          <div className="absolute top-[85%] right-[12%] text-[#F97316]/15 text-[10px] tracking-[0.4em] uppercase font-bold">
            {t("login.intelligent", "Intelligent")}
          </div>
          ...
          >
            ...
            <g opacity="0.2">
              {/* Cloud shape */}
              <path
                d="M320,420 Q280,400 300,370 Q310,340 350,340 Q390,340 400,370 Q420,360 440,380 Q470,390 460,420 Q480,450 450,470 L310,470 Q280,460 280,440 Q270,420 320,420"
                stroke="#0BB3FF"
                strokeWidth="1.5"
                fill="none"
              />
            ...
            <g opacity="0.25">
              {/* Streaming lines */}
              <path
                d="M100,550 C130,540 160,560 190,550 S250,540 280,555"
                stroke="#0BB3FF"
                strokeWidth="2"
                fill="none"
              >
              ...
              <path
                d="M100,580 C140,570 170,590 200,580 S260,570 290,585"
                stroke="#0A5ED7"
                strokeWidth="1.5"
                fill="none"
              />
              <path
                d="M100,610 C120,600 150,620 180,610 S240,600 270,615"
                stroke="#F97316"
                strokeWidth="1"
                fill="none"
              />
      ...
      <div className="w-full max-w-xl p-4 relative z-10">
          ...
          <CardContent className="pb-10 px-8">
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-3">
                <Label
                  htmlFor="email"
                  className="text-[#C4D0E4] font-medium text-base"
                >
                  {t("auth.email", "Email")}
                </Label>
                <div className="relative group">
        ...
        <div className="mt-6 p-6 bg-[#0F1319]/80 backdrop-blur-xl rounded-xl border border-[#1A2030] shadow-xl">
          ...
          <p className="text-center text-sm text-[#4A5568] mb-5 font-mono tracking-wide">
            {t("auth.passwordLabel", "Password")}: Password123!
          </p>
          <div className="grid grid-cols-3 gap-3">
            <button
              type="button"
              onClick={() => {
                setEmail("admin@salisauto.com");
            ...
            >
              <span className="text-sm font-semibold text-[#0A5ED7] group-hover:text-[#0BB3FF]">
                {t("roles.admin", "Admin")}
              </span>
            </button>
            <button
            ...
            <button
              type="button"
              onClick={() => {
                setEmail("service.manager@salisauto.com");
                setPassword("Password123!");
              }}
            ...
            >
              <span className="text-sm font-semibold text-[#0BB3FF] group-hover:text-white">
            ...
            <button
              type="button"
              onClick={() => {
                setEmail("tech@salisauto.com");
                setPassword("Password123!");
              }}
              className="p-4 rounded-xl bg-[#080B12] border border-[#1A2030] hover:border-[#0BB3FF] hover:bg-[#0BB3FF]/10 transition-all duration-200 group"
            >
              <span className="text-sm font-semibold text-[#0BB3FF] group-hover:text-white">
                {t("roles.technician", "Technician")}
              </span>
            </button>
            <button
              type="button"
              onClick={() => {
                setEmail("finance@salisauto.com");
                setPassword("Password123!");
              }}
            ...
            >
              <span className="text-sm font-semibold text-[#F97316] group-hover:text-white">
                {t("roles.finance", "Finance")}
              </span>
            </button>
            <button
              type="button"
              onClick={() => {
                setEmail("client@salisauto.com");
                setPassword("Password123!");
              }}
              className="p-4 rounded-xl bg-[#080B12] border border-[#1A2030] hover:border-[#F97316] hover:bg-[#F97316]/10 transition-all duration-200 group"
            >
