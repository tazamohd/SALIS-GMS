...
import { Box, RotateCcw, ZoomIn, ZoomOut, Eye, Layers, Activity } from 'lucide-react';
    ...
    <div className="flex-1 p-6 bg-gray-50 dark:bg-salis-black min-h-screen">
      <div className="mb-6">
        ...
        <p className="text-gray-600 dark:text-gray-400 font-['Poppins']">
          Interactive 3D vehicle visualization with real-time sensor data and diagnostic overlays
        </p>
      </div>
        ...
        <Card className="lg:col-span-3 bg-white dark:bg-salis-black">
          ...
          <CardContent>
            <div className="relative bg-gradient-to-b from-gray-900 to-gray-800 rounded-lg p-8 h-[500px] flex items-center justify-center overflow-hidden">
              {/* 3D Vehicle Visualization (CSS-based) */}
              <div
      ...
      <Card className="mt-6 bg-white dark:bg-salis-black">
        <Tabs defaultValue="diagnostics">
          <TabsList className="m-4">
            ...
            <TabsTrigger value="history" data-testid="tab-history">Simulation History</TabsTrigger>
          </TabsList>
