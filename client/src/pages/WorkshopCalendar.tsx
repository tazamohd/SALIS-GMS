...
export default function WorkshopCalendar() {
  ...
  const resources: WorkshopResource[] = [
    { id: "bay-1", name: "Bay 1 - General", type: "bay", color: "#3b82f6" },
    { id: "bay-2", name: "Bay 2 - Alignment", type: "bay", color: "#10b981" },
    { id: "bay-3", name: "Bay 3 - Paint", type: "bay", color: "#f59e0b" },
    { id: "bay-4", name: "Bay 4 - Quick Service", type: "bay", color: "#8b5cf6" },
    { id: "tech-1", name: "Ahmed (Senior Tech)", type: "technician", color: "#ec4899" },
    { id: "tech-2", name: "Mohammed (Tech)", type: "technician", color: "#06b6d4" },
  ];
  ...
  const generateEvents = (): CalendarEvent[] => {
    ...
    const sampleEvents = [
      { title: "Oil Change", customer: "Ahmed Al-Rashid", vehicle: "Toyota Camry 2022", service: "Maintenance", bay: "bay-1", dayOffset: 0, hour: 9, duration: 2 },
      { title: "Brake Inspection", customer: "Fatima Hassan", vehicle: "Honda Accord 2021", service: "Inspection", bay: "bay-2", dayOffset: 0, hour: 10, duration: 3 },
      { title: "Wheel Alignment", customer: "Mohammed Khalid", vehicle: "BMW X5 2023", service: "Alignment", bay: "bay-2", dayOffset: 1, hour: 8, duration: 4 },
      { title: "Paint Touch-up", customer: "Sara Abdullah", vehicle: "Mercedes C-Class", service: "Body Work", bay: "bay-3", dayOffset: 1, hour: 9, duration: 6 },
      { title: "AC Service", customer: "Khalid Omar", vehicle: "Nissan Patrol 2020", service: "AC/Heating", bay: "bay-1", dayOffset: 2, hour: 11, duration: 3 },
      { title: "Full Service", customer: "Nora Ahmed", vehicle: "Lexus ES 2022", service: "Full Service", bay: "bay-4", dayOffset: 2, hour: 8, duration: 4 },
      { title: "Tire Rotation", customer: "Ali Hassan", vehicle: "Ford F-150 2021", service: "Tires", bay: "bay-4", dayOffset: 3, hour: 14, duration: 1 },
      { title: "Engine Diagnostic", customer: "Layla Mohammed", vehicle: "Audi A4 2023", service: "Diagnostic", bay: "bay-1", dayOffset: 3, hour: 9, duration: 3 },
      { title: "Transmission Check", customer: "Omar Saleh", vehicle: "Chevrolet Tahoe", service: "Transmission", bay: "bay-2", dayOffset: 4, hour: 10, duration: 4 },
      { title: "Battery Replacement", customer: "Mona Yousef", vehicle: "Hyundai Sonata", service: "Electrical", bay: "bay-4", dayOffset: 4, hour: 15, duration: 1 },
    ];
  ...
  const metrics = [
    { label: "Scheduled", value: totalScheduled, icon: CalendarIcon, color: "text-blue-500" },
    { label: "In Progress", value: totalInProgress, icon: Clock, color: "text-yellow-500" },
    { label: "Completed", value: totalCompleted, icon: CheckCircle2, color: "text-green-500" },
    { label: "Utilization", value: `${utilizationRate}%`, icon: Users, color: "text-purple-500" },
  ];

  return (
    <DashboardPage
      title="Workshop Calendar"
      description="Interactive drag-and-drop scheduling for service bays and technicians"
      icon={CalendarIcon}
      metrics={metrics}
    >
          ...
          <CardContent className="p-0 overflow-x-auto">
            <div className="min-w-[1200px]">
              <div className="grid" style={{ gridTemplateColumns: "150px repeat(7, 1fr)" }}>
                <div className="p-3 border-b border-r font-medium bg-muted">Resource</div>
