...
export default function BusinessHeatMaps() {
  ...
  // Mock data for time demand heatmap (hours x days)
  ...
  const timeHeatmap = days.map(day => 
    hours.map((hour, hourIndex) => {
      ...
      const peakBonus = (hourIndex >= 3 && hourIndex <= 6) ? 15 : 0; // Peak hours
    ...
    <div className="p-8 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold font-montserrat text-gray-900 dark:text-white">
            🗺️ Business Heat Maps
          </h1>
          <p className="text-gray-600 dark:text-gray-400 mt-1">
            Visualize demand patterns, peak hours, and resource utilization
          </p>
        </div>
      ...
      <Tabs defaultValue="time" className="space-y-4">
        <TabsList className="bg-gray-100 dark:bg-salis-gray-dark">
          <TabsTrigger value="time" data-testid="tab-time">Time Demand</TabsTrigger>
          <TabsTrigger value="service" data-testid="tab-service">Service Demand</TabsTrigger>
          <TabsTrigger value="technician" data-testid="tab-technician">Technician Utilization</TabsTrigger>
        </TabsList>
