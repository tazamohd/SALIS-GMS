    ...
    <div className="flex-1 p-6 bg-gray-50 dark:bg-salis-black min-h-screen">
      <div className="mb-6">
        ...
        <p className="text-gray-600 dark:text-gray-400">
          Complete tire inventory, services, rotation scheduling, and seasonal storage
        </p>
      </div>
      ...
      <Tabs defaultValue="inventory" className="space-y-6">
        <TabsList className="bg-white dark:bg-salis-black">
          <TabsTrigger value="inventory">Tire Inventory</TabsTrigger>
          <TabsTrigger value="services">Service Records</TabsTrigger>
          <TabsTrigger value="storage">Seasonal Storage</TabsTrigger>
          <TabsTrigger value="rotations">Rotation Schedules</TabsTrigger>
        </TabsList>
